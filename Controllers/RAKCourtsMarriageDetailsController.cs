...
{
    public class RAKCourtsMarriageDetailsController : Controller
    {
            ...
            try
            {
                ...
                using (WebResponse response = request.GetResponse())
                {
                    using (StreamReader reader = new StreamReader(response.GetResponseStream()))
                    {
                        ...
                        RAKEnvelope.Envelope envelope = FromXml<RAKEnvelope.Envelope>(soapResult);
                        var marriageDetails = envelope.Body.MT_MarriageDetails_Res.Marriage.ToList();

                        if (marriageDetails.Count > 0)
                        {
                            flag = 1;
                            json = JsonConvert.SerializeObject(new { marriageDetails, flag }, new IsoDateTimeConverter() { DateTimeFormat = "yyyy-mm-dd hh:mm:ss" });
                            // LogIntegrationDetails.LogSerilog(EmiratesId, json, ConfigurationManager.AppSettings["RAKMarriageCode"].ToString(), ConfigurationManager.AppSettings["RAKMarriage"].ToString(), DateTime.Now.ToString(), string.Empty, UserAgent, User.Identity.Name);
                        ...
                        else
                        {
                            ...
                            // LogIntegrationDetails.LogSerilog(EmiratesId, ResponseDescription, ConfigurationManager.AppSettings["RAKMarriageCode"].ToString(), ConfigurationManager.AppSettings["RAKMarriage"].ToString(), DateTime.Now.ToString(), string.Empty, UserAgent, User.Identity.Name);
        ...
        //                // LogIntegrationDetails.LogSerilog(transactionId, json, ConfigurationManager.AppSettings["RAKMarriageCode"].ToString(), ConfigurationManager.AppSettings["RAKMarriage"].ToString(), DateTime.Now.ToString(), string.Empty, UserAgent, User.Identity.Name);
        ...
        //                string ResponseDescription = "No Matching Record Found";
        //                json = JsonConvert.SerializeObject(new { ResponseDescription, flag }, new IsoDateTimeConverter() { DateTimeFormat = "yyyy-mm-dd hh:mm:ss" });
        //                // LogIntegrationDetails.LogSerilog(transactionId, ResponseDescription, ConfigurationManager.AppSettings["RAKMarriageCode"].ToString(), ConfigurationManager.AppSettings["RAKMarriage"].ToString(), DateTime.Now.ToString(), string.Empty, UserAgent, User.Identity.Name);
                      ...
                      <soapenv:Body>
                          <mar:MT_MarriageDetails>
                             <Search>
                                ...
                                <ZContractDateFrom></ZContractDateFrom>
                                <ZContractDateTo></ZContractDateTo>
                             </Search>
                          </mar:MT_MarriageDetails>
                       </soapenv:Body>
                    </soapenv:Envelope>";
